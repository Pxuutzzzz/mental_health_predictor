...
<style>
    ...
    .risk-high {
        background: linear-gradient(135deg, #e74a3b, #d32e1f);
        color: white;
    }
...
<div class="questionnaire-container">
    ...
    <form id="questionnaireForm">
        ...
        <div class="question-card active" data-question="1">
            ...
            <div class="mb-4">
                <label for="age_input" class="form-label"
                    style="font-size: 16px; font-weight: 600; color: #2c3e50;">Masukkan usia Anda (tahun)</label>
                <input type="number" class="form-control form-control-lg" id="age" name="age" min="13" max="100"
                    value="25" required
                    style="font-size: 24px; text-align: center; padding: 20px; border: 2px solid #e9ecef; border-radius: 10px;"
                    placeholder="Contoh: 25">
                <small class="form-text text-muted mt-2 d-block text-center">Usia minimal 13 tahun, maksimal 100
                    tahun</small>
            </div>
        ...
        <div class="question-card" data-question="3">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="form-range" name="stress" id="stress" min="0" max="10" value="5"
        ...
        <div class="question-card" data-question="4">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="form-range" name="anxiety" id="anxiety" min="0" max="10" value="5"
        ...
        <div class="question-card" data-question="5">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="form-range" name="depression" id="depression" min="0" max="10" value="5"
        ...
        <div class="question-card" data-question="6">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="form-range" name="sleep" id="sleep" min="0" max="12" step="0.5" value="7"
        ...
        <div class="question-card" data-question="9" id="reviewPage">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr>
                            ...
                            <td class="text-end"><button class="btn btn-sm btn-link"
                                    onclick="showQuestion(1)">Edit</button></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Riwayat Mental</td>
                            <td class="fw-bold" id="review_mental">-</td>
                            <td class="text-end"><button class="btn btn-sm btn-link"
                                    onclick="showQuestion(2)">Edit</button></td>
                        </tr>
                    </table>
            ...
            <div class="alert alert-info mt-3">
                <i class="bi bi-info-circle"></i> Setelah Anda submit, AI kami akan menganalisis jawaban Anda dan
